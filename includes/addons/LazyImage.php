...
/**
 * Elementor lazy image widget.
 *
 * Elementor widget that displays an image into the page.
 *
 * @since 1.0.0
 */
class AMPFE_LazyImage extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Lazy Image', 'elementor' );
	}
	...
	public function get_keywords() {
		return [ 'image', 'photo', 'visual', 'lazy load' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'lazy_active',
			[
				'label' => __( 'Active Lazy', 'elementor' ),
				'type' => \Elementor\Controls_Manager::HIDDEN,
				'default' => 'yes',
			]
		);
	 ...
	 * lazy_active filter
	 */
	public function get_attachment_image_html_lazy( $html, $settings, $image_size_key, $image_key ) {
		
		if( isset( $settings['lazy_active'] ) && $settings['lazy_active'] == 'yes' ) {
			$html = str_replace('src', 'data-src', $html );
			$html = str_replace('sizes', 'data-sizes', $html );
			$html = str_replace('class="attachment-', 'class=" lazyload attachment-', $html );
			return $html;
		}
	...
	protected function render() {
		add_filter( 'elementor/image_size/get_attachment_image_html', [ $this, 'get_attachment_image_html_lazy' ], 10, 4 );
		...
		// Adding lazy load class to wrapper
		$this->add_render_attribute( 'wrapper', 'class', 'lazy_wrapper' );
		...
		<# if ( settings.image.url ) {
			...
			if ( link_url ) {
					#><a class="elementor-clickable" data-elementor-open-lightbox="{{ settings.open_lightbox }}" href="{{ link_url }}"><#
						...
						#><img data-src="{{ image_url }}" class="lazy {{ imgClass }}" /><#
